        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-[9px] text-slate-500 font-bold uppercase tracking-wider">MMU · Student</p>
            </div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-6 md:space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              >
                ...
                <div>
                  <h4 className="text-4xl font-black text-white italic">84.2%</h4>
                  <div className="w-full h-1.5 bg-white/5 rounded-full mt-3 overflow-hidden">
                    <div className="h-full bg-indigo-500 w-[84.2%] rounded-full shadow-[0_0_8px_rgba(99,102,241,0.5)]" />
                  </div>
                </div>
              </motion.div>
            </div>
          ...
          <div className="lg:col-span-4">
            ...
            >
              ...
              <div className="space-y-3">
                {[
                  { id: 1, type: 'Present', time: '10:14 AM', session: 'Morning Lecture' },
                  { id: 2, type: 'Present', time: '01:45 PM', session: 'Practical Lab' },
                  { id: 3, type: 'Absent', time: '09:00 AM', session: 'Seminar' },
                ].map((log) => (
                  <div key={log.id} className="flex items-center gap-3 p-3 rounded-xl bg-white/5 border border-transparent hover:border-white/10 transition-all">
                    <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${log.type === 'Present' ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
                      {log.type === 'Present' ? <CheckCircle2 size={16} /> : <XCircle size={16} />}
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-xs font-bold text-white truncate">{log.session}</p>
                      <p className="text-[9px] text-slate-500 font-bold uppercase mt-0.5">{log.time}</p>
                    </div>
                  </div>
                ))}
              </div>
